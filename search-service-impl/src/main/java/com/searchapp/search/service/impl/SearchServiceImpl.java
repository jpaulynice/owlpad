...
public class SearchServiceImpl implements SearchService {
	...
	/*
	 * (non-Javadoc)
	 * @see com.searchapp.search.service.SearchService#search(com.searchapp.search.domain.SearchRequest)
	 */
	@Override
	public SearchResponse search(SearchRequest searchRequest) throws Exception {	
		
		//will need to specify index directory for searching...this is just an example
	...
	/**
	 * Search the index for our query string and return
	 * only the maxHits count.
	 * 
	 * @param indexDir
	 * @param queryStr
	 * @param maxHits
	 ...
	 * @throws Exception
	 */
	private SearchResponse searchIndex(Directory indexDir, String queryStr, int maxHits) 
            throws Exception {
		...
		QueryBuilder queryBuilder = new QueryBuilder(new StandardAnalyzer(Version.LUCENE_47));
